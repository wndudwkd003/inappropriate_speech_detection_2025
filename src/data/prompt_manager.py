...
class PromptManager:
    ...
    SYSTEM_PROMPTS = {
        PromptVersion.V0: (
            ...
            "대화 맥락을 바탕으로 주어진 발화가 '적절'인지 또는 '부적절'인지 판단할 수 있습니다. "
    ...
    # 질문 타입별 지시 정의
    TYPE_INSTRUCTIONS = {
        PromptVersion.V0: "지시사항: 주어진 발화가 '적절'인지 또는 '부적절'인지 판단하여 답변하세요.",
        PromptVersion.V1: (
            "지시사항: 주어진 관점에 따라 논리적인 연결고리를 통해 정답으로 귀결되는 추론을 할 수 있습니다. "
            "각 관점에 따른 단계적 생각의 연결 고리는 <think> </think> 태그로 감싸세요. "
            "그리고 최종 답변은 해당 발화가 '적절'인지 또는 '부적절'인지 <answer> </answer> 태그로 감싸서 답변하세요.",
        )
    }
